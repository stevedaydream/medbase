...
// 階段與研究類型常數移到 shared（手機共用，ADR-013）
export {
  STAGE_FLOW, STAGE_REJECTED, ALL_STAGES, stageMeta, stageIndex, STUDY_TYPES, studyTypeLabel,
} from "@/shared/researchMeta";
export type { Stage, StageTone, StageMeta } from "@/shared/researchMeta";
import type { Stage } from "@/shared/researchMeta";
